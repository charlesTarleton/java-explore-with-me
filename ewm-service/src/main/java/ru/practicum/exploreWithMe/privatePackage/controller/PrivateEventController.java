...
import static ru.practicum.exploreWithMe.commonFiles.utils.ConstantaClass.Private.EVENT_CONTROLLER_LOG;
...
public class PrivateEventController {
    ...
    public List<EventShortDto> getUserEvents(@PathVariable("userId") Long userId,
                                             ...
                                             @Positive @RequestParam(value = "size", defaultValue = "10")
                                                 Integer size) {
        log.info(EVENT_CONTROLLER_LOG, "получение событий, добавленных пользователем с id: ", userId);
    ...
    public EventFullDto addEvent(@PathVariable("userId") Long userId,
        ...
        log.info(EVENT_CONTROLLER_LOG, "добавление нового события: ", eventDto);
    ...
    public EventFullDto getUserEvent(@PathVariable("userId") Long userId,
        ...
        log.info(EVENT_CONTROLLER_LOG, "получение добавленной пользователем информации о событии с id: ", eventId);
    ...
    public EventFullDto updateEvent(@PathVariable("userId") Long userId,
        ...
        log.info(EVENT_CONTROLLER_LOG, "изменение добавленного пользователем события с id: ", eventId);
    ...
    public List<ParticipationRequestDto> getEventRequests(@PathVariable("userId") Long userId,
                                                          @PathVariable("eventId") Long eventId) {
        log.info(EVENT_CONTROLLER_LOG, "получение информации о запросах на участие в событии с id: ", eventId);
    ...
    public EventRequestStatusUpdateResult approvingEventRequest(@PathVariable("userId") Long userId,
                                                                ...
                                                                @Valid @RequestBody EventRequestStatusUpdateRequest
                                                                            requestStatuses) {
        log.info(EVENT_CONTROLLER_LOG, "изменение статуса заявок на участие в событии с id: ", eventId);
